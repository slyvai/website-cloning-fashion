...
export default function ShopPages() {
    ...
    useEffect(() => {
        ...
        setCurrent(1)
        setFilter(result)
    }, [activeCategory, activeSubCategory, activeColors, activeSizes, priceRange, sortBy, products])
                            ...
                            <div className={styles.scrollable}>
                                {['Women', 'Men', 'Accessories'].map(cat => (
                                    <Checkbox
                                        ...
                                        onChange={() => toggleFilter(cat, activeCategory, setActiveCategory)}
                                    >{cat}</Checkbox>
                                ))}
                        ...
                        <div className={styles.filterTags}>
                            ...
                            <div className={styles.activeTags}>
                                ...
                                <div className={styles.tagsFilter}>
                                    {activeCategory.length > 0 && activeCategory !== 'All' && (
                                        activeCategory.map ? activeCategory.map(cat => (
                                            <span key={cat} className={styles.tag}>
                                                {cat}
                                                <button
                                                    onClick={() => toggleFilter(cat, activeCategory, setActiveCategory)}>×</button>
                                             </span>
                                        )) : (
                                    ...
                                    {(activeCategory !== 'All' || activeSubCategory.length > 0 || activeColors.length > 0 || activeSizes.length > 0 || priceRange[0] > 0 || priceRange[1] < 300) && (
